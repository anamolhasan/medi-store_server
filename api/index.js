...
var app = express();
app.use(cors({
  origin: ["http://localhost:3000", config_default.better_auth.app_url],
  credentials: true
}));
...
async function main() {
  try {
    ...
    app_default.listen(config_default.port, () => {
      console.log(`server is running on port http://localhost:${config_default.port}`);
    });
  } catch (error) {
